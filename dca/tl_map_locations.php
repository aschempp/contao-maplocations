...
(
	...
	(
		...
		'default'                     => 'headline,text;mapLocation;addImage;customPin;published'
	),
...
class tl_map_locations extends Backend
{
	...
	public function checkAddressBook()
	{
		...
		{
			$GLOBALS['TL_DCA']['tl_map_locations']['palettes']['default'] = str_replace('addImage;','addImage;linkAddress;',$GLOBALS['TL_DCA']['tl_map_locations']['palettes']['default']);
		}
	}
